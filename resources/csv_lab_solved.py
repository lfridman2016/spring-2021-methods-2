...
def add_totals(d):
    for year in d:
        total = 0
        year_data = d[year]
        for boro in year_data:
            total+= year_data[boro]
